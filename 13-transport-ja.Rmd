...
**sfnetworks** が提供するグラフと空間のデュアル機能により、多くの新しい強力な技法が可能になるが、このセクションで完全にカバーすることはできない。
...
tm_shape(existing_cycleways_buffer, bbox = bristol_region) +
 ...
 tm_lines(lwd = "bicycle",
          ...
          lwd.legend = tm_legend(title = "自転車トリップ数 (modeled, one direction)")) + tm_layout(fontfamily = "HiraginoSans-W3")
