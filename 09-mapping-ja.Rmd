...
```{r tmview, message=FALSE, fig.cap="tmap のビューモードで作成されたニュージーランドのインタラクティブマップ。インタラクティブ版は geocompr.robinlovelace.net からオンラインで入手可能。", fig.scap="Interactive map of New Zealand.", echo=FALSE}
if (knitr::is_latex_output()){
