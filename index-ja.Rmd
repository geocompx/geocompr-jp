...
[GitHub](https://github.com/geocompx/geocompr) でソースコードを公開することで、誰でも課題 (Issue) を開いたり、新しいコンテンツや誤植の修正に貢献することでプロジェクトに関わり、みんなのために役立てることができる。
...
- [GitHub](https://github.com/geocompx/geocompr/issues) または Twitter で、質問や提案を行う
