...
この 2 つの処理により、オブジェクトのメモリ使用量と、その後の解析に必要な計算資源を削減できる。ラスタデータを含む魅力的な地図を作成する前に必要な前処理工程となる場合がある。
...
```{r 06-raster-vector-40, echo=FALSE, fig.cap="ラスタ(左)のベクタ化、ポリゴン (dissolve = FALSE; 中央) と融合ポリゴン (dissolve = TRUE; 右)。", warning=FALSE, fig.asp=0.4, fig.scap="Illustration of vectorization.", dev="ragg_png"}
