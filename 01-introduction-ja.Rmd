...
ジオコンピュテーション\index{じおこんぴゅてーしょん@ジオコンピュテーション}は、地理情報科学 (GIScience) 、ジオマティクス、ジオインフォマティクス、空間情報科学、地理情報工学 [@longley_geographic_2015]、空間データサイエンス (Spatial Data Science, SDS)\index{地理データサイエンス|空間データサイエンスを参照} といった他の用語と密接に関連している。
...
地理学\index{ちりがく@地理学}は、しかしながら、コンピュータが発明されるずっと以前から、人類と自然界との関係を説明し、影響を与える上で重要な役割を担ってきた。
