...
一方、GUI ベースの GIS\index{GIS} システム (特に QGIS\index{QGIS}) にも有利な点がある。
...
また、QGIS\index{QGIS} (https://docs.qgis.org/3.28/en/docs/training_manual/processing/r_intro.html 参照) や GRASS GIS\index{GRASS}  (https://grasswiki.osgeo.org/wiki/R_statistics/rgrass#R_within_GRASS 参照) では、GIS から R を実行する環境も開発されている。
