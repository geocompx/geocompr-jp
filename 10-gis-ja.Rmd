...
シード領域拡大アルゴリズムは，主に2つのステップで動作する [@adams_seeded_1994;@bohner_image_2006]。
...
この分野の著名なプロジェクトには、[GeoMesa](http://www.geomesa.org/) と [Apache Sedona](https://sedona.apache.org/) がある。後者については、[**apache.sedona**](https://cran.r-project.org/package=apache.sedona)パッケージがインタフェースを提供している。
