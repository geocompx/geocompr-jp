...
```{r bikeshop-berlin, echo=FALSE, eval=TRUE, fig.cap="ベルリンにおける自転車店の仮想調査に従った適切なエリア（スコア> 9のラスターセル）。", fig.scap="Suitable areas for bike stores."}
