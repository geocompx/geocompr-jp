...
\index{じおめとりがた@ジオメトリ型|{sf!ジオメトリ型 を参照}}
...
\index{sf!class}
属性を説明するために、2023年6月21日のロンドンの気温が 25℃ であることを表してみたい。
...
res = knitr::knit_child('_02-ex-ja.Rmd', quiet = TRUE, options = list(include = FALSE, eval = FALSE))
cat(res, sep = '\n')
```
